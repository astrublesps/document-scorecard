...
#
# Generated Fri Apr 15 18:21:05 2016 by generateDS.py version 2.22a.
#
# Command line options:
#   ('-o', 'IR\\itemregistries.py')
#   ('-s', 'IR\\itemRegistry.py')
#
# Command line arguments:
#   Demos\People\people.xsd
#
# Command line:
#   generateDS.py -o "IR\itemregistries.py" -s "IR\itemRegistry.py" Demos\People\people.xsd
#
